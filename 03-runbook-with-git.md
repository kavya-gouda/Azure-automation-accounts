...
2. this automation will start the VM based on tag value, to make it work we need to permision to azure account managed identity to right to start the VM permision.
